...
class Settings(BaseSettings):
    ...
    smtp_username: str = Field(os.getenv("smtp_username"), description="Username for SMTP server")
    smtp_password: str = Field(os.getenv("smtp_password"), description="Password for SMTP server")
